...
#if (!isset($_SESSION['UzytkownikID']) || !isset($_SESSION['SesjaToken'])) {
#  header('Location: login.php'); // Przekierowanie na stronę logowania w wypadku, gdy nie jest zalogowany
#  exit;
#}
